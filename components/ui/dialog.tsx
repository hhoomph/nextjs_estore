/**
 * Enhanced Dialog Component with WCAG 2.1 AA Compliance
 *
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-background/80 backdrop-blur-xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 supports-backdrop-filter:bg-background/70 supports-backdrop-filter:backdrop-blur-2xl",
      className,
    )}
    {...props}
  />
