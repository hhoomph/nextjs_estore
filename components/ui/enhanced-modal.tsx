...
>(
  (
    ...
    const variants = {
      ...
      drawer:
        "fixed inset-y-0 right-0 z-50 flex h-full w-full max-w-sm flex-col border-l bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right duration-300 rtl:left-0 rtl:right-auto rtl:border-r rtl:border-l-0 rtl:data-[state=closed]:slide-out-to-left rtl:data-[state=open]:slide-in-from-left",
      centered:
