/**
 * Enhanced Dropdown Menu Component with WCAG 2.1 AA Compliance
 *
...
>(({ className, sideOffset = 4, ...props }, ref) => {
  // Use enhanced overlay content classes for better visibility
  const enhancedClasses = getOverlayContentClasses("dropdown", isDarkTheme());
