...
export function useAdminTheme() {
  ...
  const getAdminNavbarClasses = () => ({
    background:
      "bg-slate-100 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700",
  ...
  const getAdminSidebarClasses = () => ({
    ...
    menu: {
      ...
      active:
        "bg-slate-200 dark:bg-slate-600 text-slate-900 dark:text-slate-100 border-r-2 border-slate-900 dark:border-slate-100",
    },
    section: {
      title:
        "text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wider",
    },
  });
  ...
  const getAdminTableClasses = () => ({
    header:
      "bg-slate-100 dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600",
